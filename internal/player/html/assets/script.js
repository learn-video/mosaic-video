...
audioBtn = container.querySelector(".audio-config"),
...
mainVideo.addEventListener("durationchange", (event) => {
    videoDuration.innerText = formatTime(mainVideo.duration);
});
...
//     option.addEventListener("click", () => {
//         console.log('option-track', option)
...
audioBtn.addEventListener("click", () => audioOptions.classList.toggle("show"));
